import { getTextStyleFontClass, type TextStyleFontFamily } from '@/lib/textStyleFonts'

type ArticleTypography = {
  fontFamily?: TextStyleFontFamily | null
...
export function resolveArticleTypography(typography: ArticleTypography | null | undefined) {
  ...
  return {
    fontFamilyClass: getTextStyleFontClass(typography?.fontFamily, 'serif'),
