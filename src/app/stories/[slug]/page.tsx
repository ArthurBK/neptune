...
import {
  ...
  ARTICLE_BY_STORY_SLUG_QUERY,
  ARTICLE_STORY_SLUGS_QUERY,
...
export default async function StoryArticlePage({ params }: ArticlePageProps) {
  const { slug } = await params

  const [article, adTop, adMid, adBottom] = await Promise.all([
    sanityFetch<ArticleData | null>(ARTICLE_BY_STORY_SLUG_QUERY, { slug }),
